...
class ImageAlgServiceImpl(BaseAlgServiceImpl):
    def __init__(self, port):
        BaseAlgServiceImpl.__init__(self, port, server_consts.IMAGE_ALG_SERVER_NAME)
    ...
    def bye(self):
        logging.info('%a server on port %s "bye" method has been called'%(self._server_name, self._port))
